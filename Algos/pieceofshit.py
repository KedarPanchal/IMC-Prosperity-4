...
class Trader:
    ...
    Philosophy:
    - INTARIAN_PEPPER_ROOT is the main PnL engine. Get long faster, churn less, keep carry exposure.
    - ASH_COATED_OSMIUM is incremental alpha. Preserve value-per-fill while reducing the prior ask-heavy bias.
    - Keep the structure conservative enough to avoid breaking the runner that already scored ~7.8k.
    """
